...
class MyVoiceGroupMessageCard extends StatefulWidget {
  final String voiceUrl;
  final String time;
  final List<dynamic> isRead;

  const MyVoiceGroupMessageCard({
    super.key,
  ...
  @override
  State<MyVoiceGroupMessageCard> createState() => _MyVoiceGroupMessageCardState();
}

class _MyVoiceGroupMessageCardState extends State<MyVoiceGroupMessageCard> {
