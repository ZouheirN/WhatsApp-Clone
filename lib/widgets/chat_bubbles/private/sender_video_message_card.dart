...
class SenderVideoMessageCard extends StatefulWidget {
  final String videoUrl;
  final String time;

  const SenderVideoMessageCard({
    super.key,
  ...
  @override
  State<SenderVideoMessageCard> createState() => _SenderVideoMessageCardState();
}

class _SenderVideoMessageCardState extends State<SenderVideoMessageCard> {
